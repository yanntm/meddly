...
inline int bytesRequired4(INT a)
{
  ...
  static const size_t byte2 = 0xff00;
  static const size_t byte3 = byte2<<8;
  static const size_t byte4 = byte3<<8;
  if (a & (byte4 | byte3)) {
    if (a & byte4) {
      return 4;
    } else {
...
inline int bytesRequired8(INT a)
{
  ...
  static const size_t byte3 = byte2<<8;
  static const size_t byte4 = byte3<<8;
  static const size_t byte5 = byte4<<8;
  static const size_t byte6 = byte5<<8;
  static const size_t byte7 = byte6<<8;
  static const size_t byte8 = byte7<<8;
...
inline void downToData(INT  P, unsigned char* d)
{
  ...
  static const size_t nmsb = (0x40UL) << ((sizeof(INT)-1)*8);
  if (P & nmsb) {
    rawToData<bytes>(P, d);
    return;
  }
  ...
  static const size_t msboff = ~ ((0x80UL) << ((sizeof(INT)-1)*8));
